...
<!--<nav class="navbar navbar-inverse">-->
  ...
  <!--  <ul class="nav navbar-nav">
	...
	<li><a <B><p id="demo"></p></B> </a> </li>
	  ...
	  <li><a href="indexsupply.php"> <font size="2"> <span class="glyphicon glyphicon-remove"></span><B> Close</B></font> </a></li>
...
DELIVERY SYSTEM FOR UNIFIED RECORDS<br>
	...
	<form action="indexclient_supply.php" method="post" enctype="multipart/form-data">              

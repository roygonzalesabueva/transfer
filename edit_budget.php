...
$mem_id=$_GET['mem_id'];
$result=mysqli_query($conn,"SELECT * from memberbudget Where mem_id=$mem_id");
...
if(isset($_POST['update'])){
    ...
    $result=mysqli_query($conn,"Update memberbudget SET trackid='$trackid', date_created='$date_created', firstname='$firstname', lastname='$lastname', section='$section', address='$address' Where mem_id=$mem_id");
if($result){

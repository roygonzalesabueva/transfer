...
<div class="container">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<li>  
	<a href="indexclient_cashier.php"> <i class="fa fa-bar-chart" style="font-size:18px"></i><font color="White" size="4"><B>Transaction Status</B></font></a>
        </li>
...
<br><br><br><br>
	...
	<center><h3 class="text-primary"><B>Cashier's Office</B></h3></center>
...
<a class=" btn btn-sm btn-success" href="edit_cashier.php?mem_id=<?php echo $fetch['mem_id']?>" ><i class="fa fa-edit" ></i>Update</a>
...
<a onclick="acceptcashier('<?php echo $fetch['mem_id']; ?>')" class=" btn btn-sm btn-success"> <i class="fa fa-check"></i>Accept</a>
...
function acceptcashier(data_id) {
    Swal.fire({
        title: 'Are you sure?',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            window.location = ("acceptcashier.php?mem_id=" + data_id);   
...
function record(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_record.php?mem_id=" + data_id);   
...
function hrmo(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_hrmo.php?mem_id=" + data_id);   
...
function sds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_sds.php?mem_id=" + data_id);   
...
function asds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_asds.php?mem_id=" + data_id);   
...
function sgod(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_sgod.php?mem_id=" + data_id);   
...
function cid(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_cid.php?mem_id=" + data_id);   
...
function dpsu(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_dpsu.php?mem_id=" + data_id);   
...
function supply(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_supply.php?mem_id=" + data_id);   
...
function gaso(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_gaso.php?mem_id=" + data_id);   
...
function cashier(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_cashier.php?mem_id=" + data_id);   
...
function budget(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_budget.php?mem_id=" + data_id);   
...
function acctg(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_acct.php?mem_id=" + data_id);   
...
function legal(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfercashier_legal.php?mem_id=" + data_id);   

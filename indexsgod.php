...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <li> <a href="chatsgod.php"><font color="White" size="4"><B>Chat Room</B></font></a></li>
		
    <li>  
    <a href="indexclient_sgod.php"> <i class="fa fa-bar-chart" style="font-size:18px"></i><font color="White" size="4"><B>Transaction Status</B></font></a>
          </li>
...
<div class="col-md-3"></div>
	...
	<center><h3 class="text-primary"><B>Office of the School Governance and Operations Division</B></h3></center>
...
<td>
<!-- <a class="btn btn-success" href="edit_sgod.php?mem_id=<?php //echo $fetch['mem_id']?>"><i class="fa fa-edit" style="font-size:16px;color:White"><font size="4"><B>Update</B></font></i></a> -->
...
<!-- <a class="btn btn-link" href="transfersgod_record.php?mem_id=<?php //echo $fetch['mem_id']?>">Records</a> -->
    <!-- <a class="btn btn-link" href="transfersgod_hrmo.php?mem_id=<?php// echo $fetch['mem_id']?>">HRMO</a> -->
    <!-- <a class="btn btn-link" href="transfersgod_sds.php?mem_id=<?php //echo $fetch['mem_id']?>">SDS</a> -->
    <!-- <a class="btn btn-link" href="transfersgod_asds.php?mem_id=<?php //echo $fetch['mem_id']?>">ASDS</a> -->
    <!-- <a class="btn btn-link" href="transfersgod_sgod.php?mem_id=<?php// echo $fetch['mem_id']?>">SGOD</a> -->
	<!-- <a class="btn btn-link" href="transfersgod_cid.php?mem_id=<?php //echo $fetch['mem_id']?>">CID</a> -->
	<!-- <a class="btn btn-link" href="transfersgod_dpsu.php?mem_id=<?php// echo $fetch['mem_id']?>">DPSU</a> -->
	<!-- <a class="btn btn-link" href="transfersgod_supply.php?mem_id=<?php //echo $fetch['mem_id']?>">Supply</a> -->
	<!-- <a class="btn btn-link" href="transfersgod_cashier.php?mem_id=<?php //echo $fetch['mem_id']?>">Cashier</a> -->
...
function record(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_record.php?mem_id=" + data_id);   
...
function hrmo(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_hrmo.php?mem_id=" + data_id);   
...
function sds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_sds.php?mem_id=" + data_id);   
...
function asds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_asds.php?mem_id=" + data_id);   
...
function gaso(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_gaso.php?mem_id=" + data_id);   
...
function sgod(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_sgod.php?mem_id=" + data_id);   
...
function cid(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_cid.php?mem_id=" + data_id);   
...
function dpsu(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_dpsu.php?mem_id=" + data_id);   
...
function supply(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_supply.php?mem_id=" + data_id);   
...
function cashier(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_cashier.php?mem_id=" + data_id);   
...
function budget(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_budget.php?mem_id=" + data_id);   
...
function acctg(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_acct.php?mem_id=" + data_id);   
...
function legal(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersgod_legal.php?mem_id=" + data_id);   

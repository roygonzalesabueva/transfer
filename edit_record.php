...
$mem_id=$_GET['mem_id'];
$result=mysqli_query($conn,"SELECT * from memberrecord Where mem_id=$mem_id");
...
if(isset($_POST['update'])){
    ...
    $result=mysqli_query($conn,"Update memberrecord SET trackid='$trackid', date_created='$date_created', firstname='$firstname', lastname='$lastname', section='$section', address='$address' Where mem_id=$mem_id");
if($result){

    echo "Updated";
    
    header("refresh:1; url=indexrecord.php");
...
<select type="text" name="address" value="<?php  echo $address;    ?>">
    ...
    <option value="Completed/Claimed">Completed/Claimed</option>
    <option value="Approved/Claimed">Approved/Claimed</option>

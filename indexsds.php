...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <li> <a href="chatsds.php"><font color="White" size="4"><B>Chat Room</B></font></a></li>
...
<a class=" btn btn-sm btn-success" href="edit_sds.php?mem_id=<?php echo $fetch['mem_id']?>" ><i class="fa fa-edit" ></i>Update</a>
...
<div class="modal-content">
    ...
    <a href="transferscnhs_history.php?id=<?php //echo $row['id']?>">Save to Drive</a>
         <a type="button" class="btn btn-success" href="transfersds_record.php?mem_id=<?php //echo $fetch['mem_id']?>">Yes</a>
    </div>
</div>
</div>
</div> --> 
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.28/dist/sweetalert2.all.min.js"></script>
                            ...
                            <!-- <a type="button" class="btn btn-link" href="transfersds_record.php?mem_id=<?php //echo $fetch['mem_id']?>">Records</a>
                            <a type="button" class="btn btn-link" href="transfersds_asds.php?mem_id=<?php //echo $fetch['mem_id']?>">ASDS</a>
                            <a type="button" class="btn btn-link" href="transfersds_hrmo.php?mem_id=<?php //echo $fetch['mem_id']?>">HRMO</a>
                            <a type="button" class="btn btn-link" href="transfersds_sds.php?mem_id=<?php //echo $fetch['mem_id']?>">SDS</a>
                            <a type="button" class="btn btn-link" href="transfersds_sgod.php?mem_id=<?php //echo $fetch['mem_id']?>">SGOD</a>
                            <a type="button" class="btn btn-link" href="transfersds_cid.php?mem_id=<?php //echo $fetch['mem_id']?>">CID</a>
                            <a type="button" class="btn btn-link" href="transfersds_dpsu.php?mem_id=<?php //echo $fetch['mem_id']?>">DPSU</a>
                            <a type="button" class="btn btn-link" href="transfersds_supply.php?mem_id=<?php //echo $fetch['mem_id']?>">SUPPLY</a>
                            <a type="button" class="btn btn-link" href="transfersds_cashier.php?mem_id=<?php //echo $fetch['mem_id']?>">Cashier</a>
                            <a type="button" class="btn btn-link" href="transfersds_budget.php?mem_id=<?php //echo $fetch['mem_id']?>">Budget</a>
                            <a type="button" class="btn btn-link" href="transfersds_acct.php?mem_id=<?php //echo $fetch['mem_id']?>">Accounting</a>
                            <a type="button" class="btn btn-link" href="transfersds_legal.php?mem_id=<?php //echo $fetch['mem_id']?>">Legal</a>
  -->
...
function delete_data(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("delsds.php?mem_id=" + data_id);        
        }
    })
}
</script>
...
function record(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_record.php?mem_id=" + data_id);   
...
function gaso(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_gaso.php?mem_id=" + data_id);   
...
function hrmo(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_hrmo.php?mem_id=" + data_id);   
...
function sds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_sds.php?mem_id=" + data_id);   
...
function asds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_asds.php?mem_id=" + data_id);   
...
function sgod(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_sgod.php?mem_id=" + data_id);   
...
function cid(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_cid.php?mem_id=" + data_id);   
...
function dpsu(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_dpsu.php?mem_id=" + data_id);   
...
function supply(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_supply.php?mem_id=" + data_id);   
...
function cashier(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_cashier.php?mem_id=" + data_id);   
...
function budget(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_budget.php?mem_id=" + data_id);   
...
function acctg(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_acct.php?mem_id=" + data_id);   
...
function legal(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfersds_legal.php?mem_id=" + data_id);   

...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <!--  <ul class="nav navbar-nav">
	...
	<li>  
	<a href="http://202.137.126.59/transfer/indexclient.php"> <i class="fa fa-bar-chart" style="font-size:18px"></i><font color="White" size="4"><B>Transaction_Status</B></font></a>
        </li>

...
$sql = "SELECT * FROM `memberclaim` ORDER BY mem_id DESC";
...
if(isset($_POST['search']))
{
  ...
  //  $query = "SELECT * FROM `membertracking` WHERE  CONCAT(`mem_id`, `trackid`, `firstname`, `lastname`, `address`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
        ...
        $query ="SELECT * FROM `memberclaim` ORDER BY mem_id DESC";
        $search_result = filterTable($query);
...
<div class="c">
<a href="index_trans.php"> <font size="3"> <span class="glyphicon glyphicon-remove"></span><B> Close</B></font> </a>
	...
	<form action="indexclient_claim.php" method="post" enctype="multipart/form-data">

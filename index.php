            ...
            <table class="table table-bordered">
              ...
              -->
                        ...
                        <td>
                            ...
                            <a  class=" btn btn-sm btn-success"    href="acceptindex.php?mem_id=<?php echo $fetch['mem_id'] ?>"
                                 >  <i
...
<!-- 
                                    ...
                                    <a  class=" btn btn-sm btn-success"  href="edit_index.php?mem_id=<?php echo $fetch['mem_id'] ?> "  href="acceptindex.php?mem_id=<?php echo $fetch['mem_id'] ?>"
                                 >  <i
                                    class="fa fa-edit"> </i>Update</a>
 -->

    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <li><a href="#">Page 2</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#">
                            <font color="White" size="4"><B><i class="fa fa-fw fa-user"></i> <span class="nav-profile-name"><?php echo $_SESSION['username']; ?> </span></B></font>
                        </a></li>
    ...
    <nav>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li> <button class="btn btn-primary" onclick="generateTrackingID()" type="button" data-toggle="modal" data-target="#form_modal">

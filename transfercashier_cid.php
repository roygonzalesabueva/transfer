<?php
	...
	if(ISSET($_REQUEST['mem_id'])){
		...
		mysqli_query($conn, "INSERT INTO `membercid` (mem_id,trackid,firstname,lastname,section,address) VALUES('','$trackid','$firstname', '$lastname', '$section','$address')") or die(mysqli_error());

...
<div class="container">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <li> <a href="chatbudget.php"><font color="White" size="4"><B>Chat Room</B></font></a></li>
    <li>  
    <a href="indexclient_budget.php"> <i class="fa fa-bar-chart" style="font-size:18px"></i><font color="White" size="4"><B>Transaction Status</B></font></a>
          </li>
...
<br><br><br><br>
	...
	<center><h3 class="text-primary"><B> Budget Office  </B></h3></center>
...
function record(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_record.php?mem_id=" + data_id);   
...
function hrmo(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_hrmo.php?mem_id=" + data_id);   
...
function sds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_sds.php?mem_id=" + data_id);   
...
function asds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_asds.php?mem_id=" + data_id);   
...
function sgod(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_sgod.php?mem_id=" + data_id);   
...
function cid(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_cid.php?mem_id=" + data_id);   
...
function dpsu(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_dpsu.php?mem_id=" + data_id);   
...
function supply(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_supply.php?mem_id=" + data_id);   
...
function cashier(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_cashier.php?mem_id=" + data_id);   
...
function gaso(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_gaso.php?mem_id=" + data_id);   
...
function budget(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_budget.php?mem_id=" + data_id);   
...
function acctg(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_acct.php?mem_id=" + data_id);   
...
function legal(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferbudget_legal.php?mem_id=" + data_id);   

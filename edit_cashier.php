...
$mem_id=$_GET['mem_id'];
$result=mysqli_query($conn,"SELECT * from membercashier Where mem_id=$mem_id");
...
if(isset($_POST['update'])){
    ...
    $result=mysqli_query($conn,"Update membercashier SET trackid='$trackid', date_created='$date_created', firstname='$firstname', lastname='$lastname', section='$section', address='$address' Where mem_id=$mem_id");
if($result){
...
<!--Receiver<input type="text" name="section" value="<?php  echo $section;    ?>">-->
<B>Receiver</B>
<div class="input-container">                
<i class="fa fa-user icon"></i>

...
<br><br><br><br>
	...
	<center><h3 class="text-primary"><B>Office of the Assistant Schools Division Superintendent</B></h3></center>
...
<a class=" btn btn-sm btn-success" href="edit_asds.php?mem_id=<?php echo $fetch['mem_id']?>" ><i class="fa fa-edit" ></i>Update</a>
...
<a onclick="acceptasds('<?php echo $fetch['mem_id']; ?>')" class=" btn btn-sm btn-success"> <i class="fa fa-check"></i>Accept</a>
...
function hrmo(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_hrmo.php?mem_id=" + data_id);   
...
function sds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_sds.php?mem_id=" + data_id);   
...
function gaso(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_gaso.php?mem_id=" + data_id);   
...
function asds(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_asds.php?mem_id=" + data_id);   
...
function sgod(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_sgod.php?mem_id=" + data_id);   
...
function cid(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_cid.php?mem_id=" + data_id);   
...
function dpsu(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_dpsu.php?mem_id=" + data_id);   
...
function supply(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_supply.php?mem_id=" + data_id);   
...
function cashier(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_cashier.php?mem_id=" + data_id);   
...
function budget(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_budget.php?mem_id=" + data_id);   
...
function acctg(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_acct.php?mem_id=" + data_id);   
...
function legal(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferasds_legal.php?mem_id=" + data_id);   
